...
func TestConvert1(t *testing.T) {
	...
	assert.Equal(t, bigCoin.Denom, BigDenom)
...
func TestConvert2(t *testing.T) {
	...
	//htdf to satoshi
	var bigCoins []BigCoin
	bigCoins = append(bigCoins, BigCoin{Denom: "htdf", Amount: "1.2345"})
	bigCoins = append(bigCoins, BigCoin{Denom: "htdf", Amount: "2.3456"})
	bigCoins = append(bigCoins, BigCoin{Denom: "htdf", Amount: "3.4567"})
	fmt.Printf("bigCoins=%v\n", bigCoins)
	...
	//stake
	bigCoins = bigCoins[:0]
	bigCoins = append(bigCoins, BigCoin{Denom: "stake", Amount: "12345"})
	bigCoins = append(bigCoins, BigCoin{Denom: "stake", Amount: "23456"})
	bigCoins = append(bigCoins, BigCoin{Denom: "stake", Amount: "34567"})
	fmt.Printf("bigCoins=%v\n", bigCoins)
